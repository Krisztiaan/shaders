<script lang="ts">
  import { ShaderFitOptions, dotOrbitFragmentShader, getShaderColorFromString, type DotOrbitParams, type DotOrbitUniforms } from '@paper-design/shaders';
  ...
  import { defaultPreset } from './dot-orbit.js';

  type Props = ShaderComponentProps & DotOrbitParams;
