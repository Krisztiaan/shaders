<script lang="ts">
  ...
  import { defaultPreset } from './frost.js';

  type Props = ShaderComponentProps & FrostParams;
  ...
  let {
    ...
    coverage = defaultPreset.params.coverage,
    softness = defaultPreset.params.softness,
    detail = defaultPreset.params.detail,
    crystal = defaultPreset.params.crystal,
